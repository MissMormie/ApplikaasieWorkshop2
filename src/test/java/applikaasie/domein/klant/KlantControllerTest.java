...
import applikaasie.klant.adres.AdresTypeObjectRepository;
...
public class KlantControllerTest {
  ...
  private AdresTypeObjectRepository mockAdresTypeObjectRepository;
  ...
  public void setup() {
    ...
    mockAdresTypeObjectRepository = mock(AdresTypeObjectRepository.class);
            
    controller = new KlantController(mockKlantRepository, mockAdresRepository, mockAdresTypeObjectRepository, mockAccountRepository);
  ...
  public void shouldSearchAchternaamNotVoornaam() throws Exception {
    ...
    // Set reaction of mock repository
    when(mockKlantRepository.findKlantByAchternaamAndDeletedFalse("achternaam")).thenReturn(expectedKlanten);
  ...
  public void shouldSearchVoornaamNotAchternaam() throws Exception {
    ...
    // Set reaction of mock repository
    when(mockKlantRepository.findKlantByVoornaamAndDeletedFalse("voornaam")).thenReturn(expectedKlanten);
  ...
  public void shouldSearchVoornaamEnAchternaam() throws Exception {
    ...
    // Set reaction of mock repository
    when(mockKlantRepository.findKlantByVoornaamAndAchternaamAndDeletedFalse("voornaam", "achternaam")).thenReturn(expectedKlanten);
